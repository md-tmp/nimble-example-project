                        ...
                        <div class="mb-2">
                            <form @submit.prevent="form.get(route('keywords.index'))">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" v-model="form.search" id="search" class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-gray-500 focus:border-gray-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-500" placeholder="Search...">
